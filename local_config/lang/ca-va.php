<?php
// Traducció al Català per a l'Aixada i Olidecoop
...
$Text['coop_cif'] = configuration_vars::get_instance()->coop_cif;
$Text['coop_street'] = configuration_vars::get_instance()->coop_street;
$Text['please_select'] = "Seleccioneu...";
$Text['loading'] = "Si et plau, espera mentre es carreguen les dades...";
$Text['search'] = "Cerca";
$Text['id'] = "Id";
$Text['uf_short'] = "UF";
...
$Text['head_ti_active_products'] = "Activa/Desactiva Productes solicitables";
...
**/
$Text['ti_mng_activate_products'] = "Les UFs podran demanar els següents productes pel dia ";
...
$Text['ti_shop'] = "Compra d'articles ";
...
$Text['ti_my_account_money'] = "Economia";
...
$Text['products_cared_for'] = "Productes dels quals sóc responsable";
$Text['providers_cared_for'] = "Proveïdors dels quals sóc responsable";
...
$Text['deposit_other'] = "Altres tipus d'ingressos";
...
$Text['withdraw_provider'] = "Reintegrament a proveïdor";
...
$Text['logon'] = "Usuari";
$Text['pwd'] = "Clau d'accés";
$Text['old_pwd'] = "Clau d'accés antiga";
$Text['retype_pwd'] = "Torneu a escriure la clau d'accés";
$Text['lang'] = "Idioma";
...
$Text['nav_mng_db'] = "Còpia de seguretat BD";
...
$Text['nav_myaccount_account'] = "Economia";
$Text['nav_changepwd'] = "Canvia la clau d'accés"; 
$Text['nav_prev_orders'] = "Compres anteriors";
$Text['nav_logout'] = "Surt";
$Text['nav_signedIn'] = "Heu accedit com a: ";
$Text['nav_can_checkout'] = "Podeu validar compres";
$Text['nav_try_to_checkout'] = "Comença a validar";
$Text['nav_stop_checkout'] = "Para de validar";
$Text['nav_mng_rev_tax'] = "Tipus de Taxa Rev.";
...
$Text['btn_reset_pwd'] = "Reset clau d'accés"; 
...
**/
$Text['msg_err_incorrectLogon'] = "L'usuari o la clau d'accés són incorrectes. Intenta-ho de nou!";
$Text['msg_err_pwdctrl'] = "Les claus d'accés no coincideixen. Escriu-les de nou!";
$Text['msg_err_usershort'] = "El nom d'usuari és massa curt. Ha de tenir un mínim de tres caràcters";
$Text['msg_err_userexists'] = "El nom d'usuari ja existeix. Tria'n un altre.";
$Text['msg_err_passshort'] = "La clau d'accés és massa curta. Ha de tenir entre 4 i 15 caràcters";
$Text['msg_err_notempty'] = " No pot estar buit!"; 
$Text['msg_err_namelength'] = "El camp nom i cognom no pot estar buit i no pot tenir més de 255 caràcters!"; 
$Text['msg_err_only_num'] = " només accepta xifres i no pot estar buit!"; 
$Text['msg_err_email'] = "El format del correu-e no és correcte. Ha de ser del tipus nom@domini.com.";
$Text['msg_edit_success'] = "Les dades editades s'han desat correctament!";
$Text['msg_pwd_changed_success'] = "La clau d'accés s'ha canviat correctament!"; 
$Text['msg_confirm_del'] = "Segur que voleu eliminar aquest membre?";
$Text['msg_enter_deposit_amount'] = "El camp quantitat de l'ingrés només accepta xifres i no pot estar buit!";
...
$Text['prdcat_meat'] 			= "Carn";				//pollastre, vedella, xai, etc.
...
$Text['prdcat_paper'] 			= "Cel·lulosa i paper";			//mocadors, paper de vàter, paper de cuina 
$Text['prdcat_health'] 			= "Salut";				//Cremes, sabó de cos, olis corporals
...
$Text['confirm_db_backup'] = 'Segur que vols copiar tota la base de dades? Trigarà una estona...';
...
$Text['icon_incidents'] = 'Obre una incidència';
$Text['purchase_date'] = 'Data de la compra';
$Text['not_validated'] = 'Sense validar';

/* Novetats */

$Text['download_db_zipped'] = 'Descarrega la BD comprimida';
$Text['backup'] = 'Entesos, copia la base de dades!';
$Text['filter_incidents'] = 'Filtra incidència';
$Text['todays'] = "d'avui";
...
$Text['validated_at'] = "Validat en data ";
...
$Text['desc_incidents'] = "Anotar les incidències ocorregudes durant el torn.";    
...
$Text['quantity_short'] = "Quant.";
$Text['incl_iva'] = "incl. IVA";
$Text['incl_revtax'] = "incl. ImpRev";
$Text['no_news_today'] = "Avui no hi ha hagut incidents!";
$Text['nav_mng_iva'] = "Tipus d'IVA";
$Text['nav_mng_money'] = "Economia";
$Text['nav_mng_admin'] = "Administrador";
...
$Text['msg_err_nomovements'] = "No hi ha moviments per a aquest compte en aquesta data. Prova a ampliar el període consultat amb el botó de filtre.";
$Text['active_changed_uf'] = "Estat actiu de la UF modificat";
$Text['msg_err_mentoruf'] = "L'UF amfitriona no pot ser ella mateixa!";
$Text['msg_err_ufexists'] = "Ja existeix aquest nom d'UF. Tria'n un altre si et plau!";
...
$Text['wait_reset'] = "Si us plau, espera mentre reinicialitzo la comanda...";
$Text['msg_err_already_val'] = "Alguns dels elements de la comanda ja han estat validats! Ja no s'hi poden fer modificacions!";
...
$Text['ostat_revised'] = "Revisada";
$Text['ostat_finalized'] = "Finalitzada";
$Text['set_ostat_arrived'] = "Rebuda!";
$Text['set_ostat_postpone'] = "Postposada!";
$Text['set_ostat_cancel'] = "Cancel·lada!";
...
$Text['msg_move_to_shop'] = "Els articles han estat carregats a les cistelles de la compra amb les dates corresponents.";
...
$Text['dwn_zip'] = "Descàrrega en zip";
...
$Text['arrived'] = "Arribat"; 
$Text['msg_cur_status'] = "L'estat de la comanda és";
$Text['msg_change_status'] = "Canvia l'estat de la comanda a un dels següents";
$Text['msg_confirm_move'] = "Estàs segur que vols fer aquesta comanda disponible per a la venda? Tots els productes disponibles es posaran a les cistelles amb la data:";
...
$Text['order_closes'] = "La comanda es tanca el"; 
$Text['left_ordering'] = " pendents per demanar."; 
...
$Text['msg_err_deactivate_p'] = "Estàs a punt de desactivar el producte. Això vol dir que les dates en què és solicitable també s'esborraran.<br/><br/>Estàs segur que vols desactivar el producte? També podries desactivar les dates en què és solicitable, clicant a les caselles corresponents.";
$Text['msg_err_closing_date'] = "La data de tancament no pot ser posterior a la de la comanda!";
$Text['msg_err_sel_col'] = "La data seleccionada no té productes solicitables! Has d'establir un producte solicitable si vols crear una  plantilla per a aquesta data.";
$Text['msg_err_closing'] = "Per a modificar la data de tancament, hi has de posar al menys un producte solicitable.";
...
$Text['posted_by'] = "Creat per";
$Text['ostat_yet_received'] = "Pendent de rebre";
$Text['ostat_is_complete'] = "Està completa";
$Text['ostat_postponed'] = "Postposada";
$Text['ostat_canceled'] = "Cancel·lada";
$Text['ostat_changes'] = "Amb canvis";
$Text['filter_todays'] = "D'avui";
$Text['bill'] = "Factura";
$Text['member'] = "Membre";
$Text['cif_nif'] = "CIF/NIF";
$Text['bill_product_name'] = "Article";
$Text['bill_total'] = "Total"; 
$Text['phone_pl'] = "Telèfons";
$Text['net_amount'] = "Import net"; 
$Text['gross_amount'] = "Import brut";
...
$Text['nav_help'] = "Ajuda"; 
$Text['withdraw_from'] = "Retirar diners de";
$Text['withdraw_to_bank'] = "Retirar diners del banc";
$Text['withdraw_uf'] = "Retirar diners de conte UF";
$Text['withdraw_cuota'] = "Retirar quota de membre";
$Text['msg_err_noorder'] = "No s'ha trobat cap producte pel període seleccionat!";
...
$Text['do_preorder'] = "Desactivar com a comanda acumulativa";
$Text['do_deactivate_prod'] = "Activar/desactivar producte";
$Text['msg_make_preorder_p'] = "Aixó és una comanda acumulativa, per tant encara no té data d'entrega";
$Text['btn_ok_go'] = "Ok, endavant!";
$Text['msg_pwd_emailed'] = "La nova clau d'accés s'ha enviat a l'usuari";
$Text['msg_pwd_change'] = "La nova clau d'accés és: ";
...
$Text['msg_err_finalize'] = "Ups... error al finalitzar la comanda!";
$Text['msg_err_cart_sync'] = "La teva comanda no està sincronitzada amb la base de dades, s'ha modificat la teva cistella mentre estaves comprant. Torna a actualitzar la teva comanda!";
$Text['msg_err_no_deposit'] = "La última UF no ha realitzat cap dipòsit!";
...
$Text['filter_exact'] = "Escull dates";
$Text['total_4date'] = "Total";
$Text['total_4provider'] = "Suma";
$Text['sel_sales_dates'] = "Per quines dates vols consultar les vendes?";
...
$Text['msg_confirm_instantr'] = "Vols repetir aquesta acció per la resta de les dates activades?";
$Text['msg_err_delorerable'] = "Ja s'han demanat productes per aquesta data. No es pot desactivar!";
$Text['msg_pre2Order'] = "Converteix aquesta comanda acumulativa en comanda normal. Pots triar una data d'entrega";
$Text['msg_err_modified_order'] = "Algú ha modificat els productes a demanar per la data actual. Alguns productes que havíes demanat ja no estan disponibles i desapareixeran de la teva cistella una vegada recarregat.";
$Text['btn_confirm_del'] = "Estàs segur?";
$Text['print_new_win'] = "Nova finestra";
$Text['print_pdf'] = "Descarregar pdf";
$Text['msg_incident_emailed'] = "La incidència s'ha enviat correctament!";
$Text['upcoming_orders'] = "Properes comandes";
$Text['msg_confirm_del_mem'] = "Estàs segur que vols esborrar aquest usuari de la base de dades?";
$Text['btn_del'] = "Esborrar";

$Text['btn_new_provider'] = "Nou proveïdor";
$Text['btn_new_product'] = "Afegir producte";
$Text['orderable'] = "Comanda directa";
$Text['msg_err_providershort'] = "El nom del proveïdor no pot estar buit i ha de tenir com a mínim 2 caràcters.";
$Text['msg_err_productshort'] = "El nom del producte no pot estar buit y ha de tenir com a mínim 2 caràcters.";
...
$Text['msg_err_shop_unit'] = "S'ha de seleccionar una unitat de mesura per a la venta.";
$Text['click_row_edit'] = "Clica per editar.";
$Text['click_to_list'] = "Clica per per desplegar la llista de productes.";
...
$Text['msg_confirm_del_product'] = "Segur que vols eliminar aquest producte?";
$Text['msg_err_del_product'] = "No es pot eliminar aquest producte perquè hi ha entrades que depenen d'ell en la base de dades. Missatge d'error: ";
$Text['msg_err_del_member'] = "No es pot eliminar aquest usuari perquè hi ha referències al mateix en la base de dades<br/> Missatge d'error: ";
$Text['msg_confirm_del_provider'] = "Segur que vols eliminar aquest proveïdor?";
$Text['msg_err_del_provider'] = "No es pot eliminar aquest proveïdor. Elimina primer els seus productes i torna-ho a intentar.";
...
$Text['paste_column'] = "Enganxar columna";
...
$Text['google_account'] = "Conta de Google";
$Text['other_options'] = "Altres opcions";
$Text['export_publish'] = "Genera el fitxer d'exportació públic a:";
...
$Text['stock_info'] = "Nota: es poden consultar tots els canvis d'estoc (adicions, correccions, pèrdues) clicant al nom del producte aquí baix.";
$Text['stock_info_product'] = "Nota: es poden consultar tots els canvis d'estoc (adicions, correccions, pèrdues totals) des de la secció Gestiona&gt; Productes&gt; Estoc.";
$Text['info_stock_page'] = "Pàgina informació estoc";
...
$Text['msg_import_matchcol'] = "Cal fer coincidir les entrades de la base de dades amb les files de la taula. Si et plau, assigna la columna que correspon a ";
...
$Text['import_allowed'] = "Formats compatibles";
$Text['import_file'] = "Arxiu d'importació"; 
$Text['public_url'] = "URL pública";
$Text['btn_load_file'] = "Afegir arxiu";
...
$Text['ti_import_providers'] = "Importar proveïdors"; 
