...
class canned_table_manager {
 ...
 case 'aixada_order_item':
     return "['id','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','Data d_entrega','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(product)','Quantitat','TRANSLATION(ts_ordered)']";
 ...
 case 'aixada_product_orderable_for_date':
     return "['id','TRANSLATION(product_id)','Data d_entrega','TRANSLATION(closing_date)']";

 case 'aixada_provider':
     return "['id','Nom','Contacte','Adre\u00e7a','NIF','CP','Localitat','Tel\u00e8fon1','Tel\u00e8fon2','Fax','Correu-e','URL','Banc o Caixa','Compte bancari','Imatge','Observacions','Actiu','Unitat familiar responsable','Temps de proc\u00e9s','TRANSLATION(ts)']";

 case 'aixada_rev_tax_type':
     return "['Id','Nom','Descripci\u00f3','Percentatge Impost Rev.']";
 ...
 case 'aixada_iva_type':
     return "[{name:'id',index:'id',label:'Id',width:'8',xmlmap:'id',editable:false,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'name',index:'name',label:'Nom',width:'255',xmlmap:'name',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'percent',index:'percent',label:'Percentatge',width:'100',xmlmap:'percent',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'description',index:'description',label:'Descripci\u00f3',width:'150',xmlmap:'description',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}}]";
 ...
 case 'aixada_unit_measure':
     return "[{name:'id',index:'id',label:'Id',width:'8',xmlmap:'id',editable:false,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'name',index:'name',label:'Nom',width:'255',xmlmap:'name',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'unit',index:'unit',label:'Unitat',width:'100',xmlmap:'unit',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}}]";
